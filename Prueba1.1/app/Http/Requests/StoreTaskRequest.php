...
class StoreTaskRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            'project_id' => [
                'required',
                'uuid', // Valida que sea un formato UUID
                Rule::exists('projects', 'id'), // Valida que el project_id exista en la tabla projects
            ],
            ...
            'due_date' => 'required|date|after_or_equal:today', // Fecha de vencimiento, no puede ser una fecha pasada
        ];
    }
